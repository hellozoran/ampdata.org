<template lang="html">
  <div :class="{ 'expanded': searchIsOpen }" class="search">
    <OnClickOutside :do="close">
      <div>
        <button
          class="outline-none focus:outline-none focus:shadow-outline focus:border-green-500"
          tabindex="0"
          @click="searchInput">
          <svg
        ...
        <input ref="search" v-model="searchTerm" type="text" class="search-field outline-none focus:ring focus:ring-blue-300">
      </div>
    </OnClickOutside>
  </div>
</template>
